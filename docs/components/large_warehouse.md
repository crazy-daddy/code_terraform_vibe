# Component: large_warehouse

> **Category:** Production & Storage | **Component Name:** Large Warehouse
...
| --- | --- |
| Type | Mining |
| Storage | 15 slots × 2,000 units |

### How to obtain

1. Requires the **Large Warehouse** research (Biomass 30,000).
