...
| --- | --- | --- |
| `name` | `string` | Display name or id of the destination Drone Depot or Drone Service Station. |
...
| Name | Type | Description |
| --- | --- | --- |
| `name` | `string` | Display name or id of a deployed Mining Drill (any tier). |
...
| Name | Type | Description |
| --- | --- | --- |
| `slot_index` | `number` | Whole-number drone slot index, starting at 0. |
| `module_id` | `string` | Shop id of the drone module |
