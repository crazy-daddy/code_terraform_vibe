...
| Name | Type | Description |
| --- | --- | --- |
| `recipe_or_id` | `str \| Recipe \| IdRecord` | Refiner recipe id, a `Recipe` object, or a dictionary or class instance with a string `id` field. The recipe must belong to this machine and be unlocked. |
...
##### `.purge_input() → ActionResult` *(self only)*
