...
| --- | --- | --- |
| `slot_index` | `int` | Whole-number zero-based slot position on the chassis. |
| `item_id` | `str` | Shop id of the module to mount. |
...
| Name | Type | Description |
| --- | --- | --- |
| `slot_index` | `int` | Whole-number slot where the container (Battery Holder / Cargo Rack) is mounted. |
| `internal_index` | `int` | Whole-number zero-based index within the container's internal slots. |
| `item_id` | `str` | Shop id of the portable item to install. |
...
| Name | Type | Description |
| --- | --- | --- |
| `slot_index` | `int` | Whole-number slot where the container is mounted. |
| `internal_index` | `int` | Whole-number zero-based index within the container's internal slots. |
