...
| Name | Type | Description |
| --- | --- | --- |
| `item_id` | `string` | Optional item id, makes the check stack-aware for that exact variant |
| `properties` | `any` | Exact property dict from a `Slot` or `ItemStack`; None selects the propertyless variant |
...
| Name | Type | Description |
| --- | --- | --- |
| `slot` | `number` | Whole-number inventory slot index |
...
| Name | Type | Description |
| --- | --- | --- |
| `item_id` | `string` | Item id to drop every stack of |
