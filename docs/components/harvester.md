...
| --- | --- | --- |
| `sector` | `string` | Adjacent grid sector id to move to (one cardinal step). |
...
| Name | Type | Description |
| --- | --- | --- |
| `seed` | `string` | Seed item id from the Seed Maker. Loading transfers one seed from Inventory into the Harvester's single held slot, from anywhere on the grid. |
...
| Name | Type | Description |
| --- | --- | --- |
| `seed` | `string` | Seed item id matching the physical seed in the Harvester's held slot. |
...
| Name | Type | Description |
| --- | --- | --- |
| `kit` | `string` | Fixed field-machine kit item id unlocked by current research. |
...
| Name | Type | Description |
| --- | --- | --- |
| `item_id` | `string` | Fertilizer item id picking the tier; omit for Mk I. |
...
| Name | Type | Description |
| --- | --- | --- |
| `sector` | `string` | Grid sector id (e.g. `"E13"`). |
