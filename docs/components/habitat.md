...
| --- | --- | --- |
| `creature_id` | `string` | Cataloged creature id to prepare in this Habitat (e.g. `"salt_tortoise"`). |
...
| Name | Type | Description |
| --- | --- | --- |
| `creature_id` | `string` | Established creature colony to attach to this Habitat (e.g. `"salt_tortoise"`). |
...
| Name | Type | Description |
| --- | --- | --- |
| `rate` | `number` | Gas inflow rate in t/h, pulled from the connected Gas Tank into the enclosure's gas reserve. Meter this to hold `gas_band()`. |
...
| Name | Type | Description |
| --- | --- | --- |
| `port` | `string` | Inlet to vent: `"gas_in"` or `"liquid_in"`. Omit to vent both. |
...
| Name | Type | Description |
| --- | --- | --- |
| `medium` | `string` | Enclosure reserve to empty: `"gas"` or `"liquid"`. The selected fluid is destroyed. |
...
| Name | Type | Description |
| --- | --- | --- |
| `rate` | `number` | Liquid inflow rate in t/h, pulled from the connected Liquid Tank into the enclosure's liquid reserve. Meter this to hold `liquid_band()`. |
...
| Name | Type | Description |
| --- | --- | --- |
| `node_id` | `string` | Node id from `get_bonus_tree().nodes`. |
